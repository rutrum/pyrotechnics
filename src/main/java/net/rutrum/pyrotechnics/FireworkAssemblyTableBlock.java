...
public class FireworkAssemblyTableBlock extends Block {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        ...
        player.openHandledScreen(new SimpleNamedScreenHandlerFactory(
            (syncId, inventory, p) -> new FireworkAssemblyTableScreenHandler(syncId, inventory, ScreenHandlerContext.EMPTY
            ), TITLE));
