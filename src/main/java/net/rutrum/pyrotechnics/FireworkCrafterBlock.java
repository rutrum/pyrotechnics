...
public class FireworkCrafterBlock extends Block {
    private static final Text TITLE = new TranslatableText("container.firework_crafting");

    public FireworkCrafterBlock(Settings settings) {
        super(settings);
    }
